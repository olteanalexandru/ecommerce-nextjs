...
export function Navbar({ initialMenu, customerMenu }: NavbarProps) {
  ...
  return (
    <div className="relative z-50">
      ...
      <div id="main-header" className="w-full z-50 transition-all duration-300 bg-white/90 dark:bg-black/90 backdrop-blur-xl shadow-lg shadow-primary/10">
        {/* Main Header */}
        <div className="border-b border-neutral-200 dark:border-neutral-800 bg-gradient-to-b from-white/80 to-white/60 dark:from-black/80 dark:to-black/60">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between p-0 lg:px-4 relative h-16">
